...
class StockLotHistory(models.TransientModel):
    ...
    def action_generate_report(self):
        ...
        - Returns a tree view action showing the generated report.
        """
        self.ensure_one()
        ...
        for line in move_lines:
            ...
            if line.location_dest_id.id in self.location_ids.ids:
                ...
                summary[key]["incoming"] += line.quantity
            ...
            if line.location_id.id in self.location_ids.ids:
                ...
                if key not in summary:
                    summary[key] = {"incoming": 0.0, "outgoing": 0.0}
                summary[key]["outgoing"] += line.quantity
        ...
        # Return an action to open the report in tree view (popup)
        return {
